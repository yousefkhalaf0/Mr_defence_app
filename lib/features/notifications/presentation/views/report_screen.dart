...
class ReportScreen extends StatefulWidget {
  ...
  const ReportScreen({super.key, this.hasData = true});
...
class _ReportScreenState extends State<ReportScreen>
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            _buildDataFrame(
              title: 'Thursday',
              items: thursdayReports.map((data) {
  ...
  Widget _buildReportItem(
      String name, String description, String status, String time) {
  ...
  Widget _buildSecondFrameItem(
      String name, String description, String label, String time) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
